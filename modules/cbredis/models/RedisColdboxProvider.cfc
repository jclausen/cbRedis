...
*/
component name="RedisColdboxProvider" serializable="false" extends="RedisProvider" implements="coldbox.system.cache.IColdboxApplicationCache"{

	property name="JavaLoader" inject="Loader@cbjavaloader";

	RedisColdboxProvider function init() output=false{
		super.init();
