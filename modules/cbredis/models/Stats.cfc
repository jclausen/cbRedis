...
Stats for Redis Provider
*/
component name="RedisStats" implements="coldbox.system.cache.util.ICacheStats" accessors="true"{
	...
	*/
	function init( cacheProvider ) output=false{
		...
		variables.instance.cacheStats = arguments.cacheProvider.getRedisClient().getStats().values().toArray();
		return this;
	}
